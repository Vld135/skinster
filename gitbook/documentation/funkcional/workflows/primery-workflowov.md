...
* Максимальная стоимость: `$0.90` (чтобы не отправить дорогие предметы — настройте под свои нужды)
...
{% hint style="warning" %}
Диапазон цен `$0 – $0.90` задан в шаблоне специально, чтобы не разослать дорогие предметы. Если нужно отправлять всё — отключите "Фильтр по стоимости" или расширьте диапазон.
{% endhint %}
