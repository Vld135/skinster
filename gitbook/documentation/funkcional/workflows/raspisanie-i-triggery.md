...
| Часовой пояс | Часовой пояс для времени запуска | `select` | Москва (UTC+3) |
...
Запуск фарма каждый день в 23:00 по Москве, по будням:
* Время запуска: `23:00`
...
| Часовой пояс | Часовой пояс для расписания | `select` | Москва (UTC+3) |
| Пропускать при ошибке | Не запускать если предыдущий запуск завершился с ошибкой | `boolean` | Нет |
