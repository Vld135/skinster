...
<figure><img src="../../.gitbook/assets/workflow-conditions.png" alt=""><figcaption></figcaption></figure>
...
2. Выход **yes** → переходим к Armory (пропуски уже есть)
3. Выход **no** → переходим к **Buy Passes** → **Activate Armory Pass** → затем к Armory
